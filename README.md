...
These steps won't work for save files where Jet Vermilion has already been unlocked.

1. Open https://waluigibsod.github.io/fzmv-password-generator/.
2. Enter the name of the save file where you wish to unlock Jet Vermilion on the website before selecting it (it's case insensitive but leading spaces or ones between letters and symbols matter).
3. Select the save file, then Start and then Grand Prix mode.
4. While on the machine selection screen press in sequence **L**, **R**, **Start**, **R**, **L**, **Select** and a new screen named Password with no background music should appear.
5. Enter the generated password in-game (remember that the keyboard cursor wraps around both horizontally and vertically), then press O.K. at the end. A jingle should confirm the correct entry before being sent back to the machine selection screen.
